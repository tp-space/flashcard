...
<div class="tp-has-card">
    <div class="row mt-3 mb-3">
        ...
        <div class="col-md-6" style="background-color:orange;">
            ...
            <div>
                ...
                <span class="tp-toggle-label" data-state="off"></span>
    ...
    <div class="tp-toggle-example" data-state="off">
